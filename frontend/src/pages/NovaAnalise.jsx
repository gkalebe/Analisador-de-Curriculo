            ...
            {vagas.length > 0 && (
              <ul className="space-y-2">
                {vagas.map((vaga) => (
                  <li key={vaga.id_vaga}>
                    <label
                      className={`flex cursor-pointer items-start gap-3 rounded-lg border-[0.5px] p-4 hover:border-[#1e5e3f] transition-colors ${
                        idVagaSelecionada === vaga.id_vaga ? "border-[#1e5e3f] bg-[#f0fdf4]" : "border-gray-200"
                      }`}
                    >
                      <input
                        type="radio"
                            ...
                            <div className="flex items-center gap-3 min-w-0">
                              <div
                                className={`w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 ${
                                  selecionado ? "bg-[#1e5e3f] text-white" : "bg-gray-100 text-gray-600"
                                }`}
                              >
